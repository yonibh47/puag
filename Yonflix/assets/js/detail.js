...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&append_to_response=casts,videos,images,releases`, function (movie) {
    ...
    movieDetail.innerHTML = `
        ...
        <div class="detail-box">
            ...
            <div style="margin-bottom: 20px; position: relative; width: 100%; padding-bottom: 56.25%; overflow: hidden;">
                <iframe src="https://vidsrc.to/embed/movie/${id}" frameborder="0" allowfullscreen="1" title="${title}" loading="lazy" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border-radius: 16px;"></iframe>
            </div>

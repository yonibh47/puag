...
export function sidebar() {
    ...
    sidebarInner.innerHTML = `
            ...
            <div class="sidebar-list">
                ...
                <a href="./movie-list.html" menu-close class="sidebar-link" onclick='getMovieList("with_original_language=sp", "Spanish")'>Spanish</a>
            </div>

            <div class="sidebar-footer">
                <p class="copyright">Copyright 2024 <a href="#">Yonatan Bedilu</a></p>
